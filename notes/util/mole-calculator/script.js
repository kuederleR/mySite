...
function moles (atomic_number, grams) {
    let atomic_mass = elements.elements[order[atomic_number] - 1].atomic_mass; 
    return grams / atomic_mass;
}

function grams (atomic_number, moles) {
    let atomic_mass = elements.elements[order[atomic_number] - 1].atomic_mass; 
    return moles * atomic_mass;
}
console.log(grams("magnesium", 0.050));



document.getElementById("slider").onclick = function() {change()};
let state = false;
...
function change() {
    ...
    if (state) {
        ...
        document.getElementById("slider").style.backgroundColor = "#aadddd";
        document.getElementById("slider").style.transform = "translatex(100%)";
        document.getElementById("slider").innerHTML = "GRAM";
        document.getElementById("num").style.borderColor = "#aadddd";
    }
    else {
        document.getElementById("slider").style.backgroundColor = "#dddddd";
        document.getElementById("slider").style.transform = "translatex(0)";
        document.getElementById("slider").innerHTML = "MOLE";
        document.getElementById("num").style.borderColor = "#dddddd";

    }
}

document.getElementById("output").onclick = function() {calculate()};
...
function calculate() {
    ...
    let element = document.getElementById("element-selection").value;
    let num = document.getElementById("num").value;
    if (state) {
        document.getElementById("output").innerText = moles(element, num) + unit;
    }
    else {
        document.getElementById("output").innerText = grams(element, num) + unit;
    }
